...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::table('courses')->insert([
            ...
            'elevation' => 10,
            'map_image' => 'img/map_images/1710867860_Lightning Speed Dash.png',
            'max_participants' => 20,
            'distance_km' => 10.5,
            'date' => '2025-01-07',
            'time' => '09:00:00',
            'location' => '123 Electric Speed Street',
            'promotion_poster' => 'img/promotion_posters/1710867860_Lightning Speed Dash.jpg',
        ...
        DB::table('courses')->insert([
            'name' => 'Electric Scooter Rally',
            'description' => 'Is an exciting event where electric mobility enthusiasts compete in an electric scooter race',
            'elevation' => 30,
            'map_image' => 'img/map_images/1710868556_Electric Scooter Rally.png',
            'max_participants' => 30,
            'distance_km' => 15,
            'date' => '2024-09-03',
            'time' => '12:00:00',
            'location' => '98 Volt Street',
            'promotion_poster' => 'img/promotion_posters/1710868556_Electric Scooter Rally.jpg',
        ...
        DB::table('courses')->insert([
            ...
            'elevation' => 60,
            'map_image' => 'img/map_images/1710868952_Extreme Glide Challenge.png',
            'max_participants' => 10,
            'distance_km' => 5,
            'date' => '2024-07-15',
            'time' => '16:00:00',
            'location' => '33 Extreme Velocity Street',
            'promotion_poster' => 'img/promotion_posters/1710868952_Extreme Glide Challenge.jpg',
        ...
        DB::table('courses')->insert([
            ...
            'elevation' => 0,
            'map_image' => 'img/map_images/1710869269_Voltage Velocity Race.png',
            'max_participants' => 60,
            'distance_km' => 20.8,
            'date' => '2024-03-15',
            'time' => '20:00:00',
            'location' => '13 Voltage Velocity Street',
            'promotion_poster' => 'img/promotion_posters/1710869269_Voltage Velocity Race.jpg',
        ...
        DB::table('courses')->insert([
            ...
            'elevation' => 5,
            'map_image' => 'img/map_images/1710869625_Turbo Scoot Showdown.png',
            'max_participants' => 8,
            'distance_km' => 12,
            'date' => '2024-04-05',
            'time' => '13:00:00',
            'location' => 'Electric Avenue, 24A',
            'promotion_poster' => 'img/promotion_posters/1710869625_Turbo Scoot Showdown.jpg',
        ...
        DB::table('courses')->insert([
            'name' => 'Electrifying Circuit Thrill',
            ...
            'elevation' => 45,
            'map_image' => 'img/map_images/1710869944_Electrifying Circuit Thrill.png',
            'max_participants' => 66,
            'distance_km' => 4,
            'date' => '2024-05-22',
            'time' => '17:00:00',
            'location' => 'Spark Avenue, 456',
            'promotion_poster' => 'img/promotion_posters/1710869944_Electrifying Circuit Thrill.jpg',
        ...
        DB::table('courses')->insert([
            'name' => 'Electric Scooter Grand Prix',
            'description' => 'Is an exciting electric scooter race that combines speed, skill and agility in an exciting competitive event',
            'elevation' => 23,
            'map_image' => 'img/map_images/1710870352_Electric Scooter Grand Prix.png',
            'max_participants' => 77,
            'distance_km' => 24,
            'date' => '2024-06-17',
            'time' => '10:00:00',
            'location' => 'Electric Boulevard, 789',
            'promotion_poster' => 'img/promotion_posters/1710870352_Electric Scooter Grand Prix.jpg',
        ...
        DB::table('courses')->insert([
            ...
            'elevation' => 8,
            'map_image' => 'img/map_images/1710870706_Wheelie Voltage Marathon.png',
            'max_participants' => 35,
            'distance_km' => 14,
            'date' => '2024-03-22',
            'time' => '15:00:00',
            'location' => '45 Electrodynamics Street',
            'promotion_poster' => 'img/promotion_posters/1710870706_Wheelie Voltage Marathon.jpg',
        ...
        DB::table('courses')->insert([
            'name' => 'Spark Circuit Sprint',
            'description' => 'Competitors face off in an intense competition where maneuvering skills and speed are key to victory',
            'elevation' => 21,
            'map_image' => 'img/map_images/1710871066_Spark Circuit Sprint.png',
            'max_participants' => 44,
            'distance_km' => 9,
            'date' => '2024-03-13',
            'time' => '23:00:00',
            'location' => 'Lightning Lane Avenue, 456',
            'promotion_poster' => 'img/promotion_posters/1710871066_Spark Circuit Sprint.jpg',
